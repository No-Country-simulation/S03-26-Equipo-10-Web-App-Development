/**
 * Purpose: Define the future canonical navigation model.
 * Responsibilities: Describe global and local navigation items aligned with the information architecture.
