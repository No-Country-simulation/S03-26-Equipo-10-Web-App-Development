...
export default function AnalyticsPlaceholderPage() {
  return (
    <main aria-labelledby="analyticsplaceholderpage-title" className="p-6">
      <h1 id="analyticsplaceholderpage-title">Analytics Placeholder</h1>
      <p>This route is reserved for the future analytics screen under the new architecture.</p>
    </main>
  );
}
