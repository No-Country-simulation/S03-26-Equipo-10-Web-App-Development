...
export default function DashboardPlaceholderPage() {
  return (
    <main aria-labelledby="dashboardplaceholderpage-title" className="p-6">
      <h1 id="dashboardplaceholderpage-title">Dashboard Placeholder</h1>
      <p>This route is reserved for the future dashboard home screen under the new architecture.</p>
    </main>
  );
}
