 ...
 */
export default function WebhooksSettingsPlaceholderPage() {
  return (
    <main aria-labelledby="webhookssettingsplaceholderpage-title" className="p-6">
      <h1 id="webhookssettingsplaceholderpage-title">Webhooks Settings Placeholder</h1>
      <p>This route is reserved for the future webhooks settings screen under the new architecture.</p>
    </main>
  );
}
