/**
 * Purpose: Adapt Cloudinary media services to the internal storage abstraction.
 * Responsibilities: Encapsulate upload, transformation and asset lookup behavior for media workflows.
