/**
 * Purpose: Define the authentication configuration contract for the API.
 * Responsibilities: Describe secrets, token lifetimes and authentication-related environment mapping.
