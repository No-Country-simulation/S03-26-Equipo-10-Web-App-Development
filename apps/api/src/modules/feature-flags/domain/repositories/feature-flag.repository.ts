/**
 * Purpose: Define the repository contract for the feature-flags domain.
 * Responsibilities: Describe persistence operations required by the application layer without exposing infrastructure details.
