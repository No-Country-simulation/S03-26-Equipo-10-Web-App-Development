/**
 * Purpose: Define the Prisma-backed repository adapter for the feature-flags module.
 * Responsibilities: Translate between Prisma persistence concerns and the repository contract expected by the application layer.
