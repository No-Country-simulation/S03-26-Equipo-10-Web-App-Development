  ...
  getOpenApiDocument() {
    return {
      ...
      paths: {
        ...
        '/public/testimonials/tenants/{slug}': { get: { summary: 'Public list testimonials by tenant slug' } },
        '/public/testimonials/tenants/{slug}/{testimonial_id}': { get: { summary: 'Public get testimonial by tenant slug' } },
        '/public/analytics/events': { post: { summary: 'Track analytics event (API key)' } },
        '/public/analytics/tenants/{slug}/events': { post: { summary: 'Track analytics event by tenant slug' } },
