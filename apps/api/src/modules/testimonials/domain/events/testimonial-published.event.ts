/**
 * Purpose: Define the future domain event emitted when a testimonial is published.
 * Responsibilities: Capture the canonical payload and semantic meaning of a testimonial publication event.
