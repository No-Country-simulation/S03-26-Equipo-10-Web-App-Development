...
import { PublicTestimonialsQueryDto } from '../../application/dto/testimonials.dto';
...
export class PublicTestimonialsController {
  ...
  list(
    ...
    return this.testimonialsService.listPublic(tenantId, query);
  }
  ...
  getOne(
    ...
    return this.testimonialsService.getPublicById(tenantId, testimonialId);
  }
}
